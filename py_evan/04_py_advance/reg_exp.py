...
if __name__ == '__main__':
    ...
    # print(result)
    print(result.groups())
    print(result.group(1))  # s-top-nav
    print(result.group(2))  # display:none;
    print(result.group(3))  # s-center-box
    # print(result.group(4))
    re_g = re.compile('\s')
    result = re_g.split(html)
    print(result)  # ['<div', 'class="s-top-nav"', 'style="display:none;"></div><div', 'class="s-center-box"></div>']
