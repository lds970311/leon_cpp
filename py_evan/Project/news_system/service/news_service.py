# coding:utf-8
# time: 2023/5/17
from Project.news_system.db.mongo_news_dao import MongoNewsDao
...
class NewsService:
    ...
    def delete_by_id(self, id):
        self.__news_dao.delete_by_id(id)  # 删除mysql
        content_id = self.__news_dao.search_content_id(id)
        self.__mongo_dao.delete_by_id(content_id)  # 删除MongoDB

    def insert(self, title, editor_id, type_id, content, is_top):
        self.__mongo_dao.insert(title, content)
        content_id = self.__mongo_dao.serach_news_id(title)
    ...
    def update(self, news_id, new_title, type_id, content, new_is_top):
        """
        更新新闻
        :param news_id:
        :param new_title:
        ...
        self.__mongo_dao.update_news(news_id, new_title, content)
    ...
    def search_content_by_id(self, id):
        return self.__mongo_dao.search_content_by_id(id)
